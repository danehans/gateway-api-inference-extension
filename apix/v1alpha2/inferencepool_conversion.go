...
func (src *InferencePool) ConvertTo(dst *v1.InferencePool) error {
	...
	dst.Spec.EndpointPickerRef = v1Extension
	dst.Status = *v1Status
...
func (dst *InferencePool) ConvertFrom(src *v1.InferencePool) error {
	...
	extensionRef, err := convertExtensionRefFromV1(&src.Spec.EndpointPickerRef)
	if err != nil {
		return err
	}
...
func convertExtensionRefToV1(src *Extension) (v1.EndpointPickerExtension, error) {
	if src == nil {
		return v1.EndpointPickerExtension{}, errors.New("src cannot be nil")
	}
	u, err := toUnstructured(src)
	if err != nil {
		return v1.EndpointPickerExtension{}, err
	}
	out, err := convert[v1.EndpointPickerExtension](u)
	if err != nil {
		return v1.EndpointPickerExtension{}, err
	}
	return *out, nil
...
func convertExtensionRefFromV1(src *v1.EndpointPickerExtension) (Extension, error) {
	if src == nil {
