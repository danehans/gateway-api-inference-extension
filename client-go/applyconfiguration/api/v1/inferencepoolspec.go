...
type InferencePoolSpecApplyConfiguration struct {
	...
	EndpointPickerRef *EndpointPickerExtensionApplyConfiguration `json:"endpointPickerRef,omitempty"`
}
...
func (b *InferencePoolSpecApplyConfiguration) WithEndpointPickerRef(value *EndpointPickerExtensionApplyConfiguration) *InferencePoolSpecApplyConfiguration {
